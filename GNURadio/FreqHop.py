...
# Title: Freqhop
# Generated: Sun Jan 24 19:23:11 2016
##################################################
...
class FreqHop(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Freqhop")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Freqhop")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "FreqHop")
        ...
        self.multihop_multihop_rendezvous_0 = multihop.multihop_rendezvous(981234, freqhop_rate, samp_rate, num_channels, window_size, search_speed)
        ...
        self.connect((self.multihop_freq_to_channel_0, 0), (self.multihop_multihop_rendezvous_0, 0))    
    ...
    def set_search_speed(self, search_speed):
